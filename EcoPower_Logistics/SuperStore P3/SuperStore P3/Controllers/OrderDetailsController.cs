...
namespace Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        private readonly IODetailsRepository _ODetailsRepository;
        public OrderDetailsController(IODetailsRepository oDetailsRepository)
        {
            _ODetailsRepository = oDetailsRepository;
        }
        ...
        {
            return View(_ODetailsRepository.GetAll());
        }
